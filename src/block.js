...
class Block {
    ...
    getBData() {
        ...
        console.log("getBdataya girildi");
        let self = this;
        ...
        return new Promise((resolve,reject) => {
            ...
            let decoded_data = hex2ascii(data);
            ...
            if(self.previousBlockHash === null){
               ...
               //reject(Error("Be Carefull ! You are trying to get the data of Genesis Block"))
               console.log("Genesiss");
            }
            else{
